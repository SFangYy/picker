...
// Note: Assumes the original transaction .sv file is copied to current directory
// You may need to adjust this path based on your actual file location
`include "DUT{{className}}/{{className}}_xagent.sv"
...
class example_env extends uvm_env;
    ...
    function void connect_phase(uvm_phase phase);
        ...
        // Connect driver to monitor for echo back
